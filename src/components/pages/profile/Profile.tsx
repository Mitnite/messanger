                        ...
                        <div style={{display: "flex", justifyContent: 'center', alignItems: "start"}}>
                          ...
                          <div style={{display: "flex", justifyContent: 'center', alignItems: "start"}}>
                            ...
                            <TextField
                                ...
                                value={userId.university}
                                onChange={e => setUserId({...userId, university: e.target.value})}
                            />
                            <TextField
                                label='Ваш статус'
                                variant='outlined'
                                ...
                                value={userId?.status}
                                onChange={e => setUserId({...userId, status: e.target.value})}
                            />
